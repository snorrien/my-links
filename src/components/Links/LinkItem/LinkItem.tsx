...
import { moveLink } from "../../../redux/actions/LinkActionCreator";
...
function LinkItem({ link, editCard, deleteCard }: Props) {
    ...
    function handleEditCard(link: LinkType) {
        editCard(link);
    };

    function handleDeleteCard(link: LinkType) {
        deleteCard(link);
    };
    ...
    return (
        <div ref={drag} className="linkItem">
            <img className="linkItem__image" src="./imgs/dog.jpg" />
            <div className="linkItem-content">
                <div className="linkItem__title">
                    <div>{link.title.length > 45 ? `${link.title.slice(0, 45)}...` : link.title}</div>
                    <div>
                        <div className="edit-button" onClick={() => handleEditCard(link)}>
                        ...
                        <div className="edit-button" onClick={() => handleDeleteCard(link)}>
